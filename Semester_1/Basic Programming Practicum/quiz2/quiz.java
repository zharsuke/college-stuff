...
public class quiz {
    public static void main(String[] args) {
        ...
        int highestBorrowed1 = 0;
        int highestBorrowed2 = 0;
        for (int i = 0; i < item.length; i++) {
            int canBorrowed = amount[i][0] - amount[i][1];
            if (canBorrowed > highestBorrowed1) {
                highestBorrowed1 = canBorrowed;
                highestBorrowed2 = i;
            }
        }
        System.out.printf("The most borrowd is %s", item[highestBorrowed1]);
    }
}